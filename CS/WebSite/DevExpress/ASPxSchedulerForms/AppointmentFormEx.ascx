...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="AppointmentFormEx" CodeFile="AppointmentFormEx.ascx.cs" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.2, Version=10.2.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v10.2, Version=10.2.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4" Namespace="DevExpress.Web.ASPxScheduler.Controls" TagPrefix="dxsc" %>
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v10.2, Version=10.2.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.Web.v10.2, Version=10.2.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4" Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
...
<table>
    <tr>
        <td  class="dxscDoubleCell" colspan="2">
            <dxe:ASPxCheckBox ID="chkRecurrence" runat="server" Text="Recurrence" Checked='<%# ((AppointmentFormTemplateContainer)Container).Appointment.IsRecurring %>'>
