...
Partial Public Class [Default]
    ...
    Protected Sub ASPxScheduler1_BeforeExecuteCallbackCommand(ByVal sender As Object, ByVal e As SchedulerCallbackCommandEventArgs)
        If e.CommandId = "MYAPTMENU" Then
            e.Command = New MyMenuAppointmentCallbackCommand(DirectCast(sender, ASPxScheduler))
        End If
    End Sub
    Protected Sub ASPxScheduler1_PopupMenuShowing(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxScheduler.PopupMenuShowingEventArgs)
        ...
        If menu.MenuId = DevExpress.XtraScheduler.SchedulerMenuItemId.AppointmentMenu Then
...
Public Class MyMenuAppointmentCallbackCommand
    ...
    Protected Overrides Sub ExecuteCore()
        ...
        If FormType <> FormType.None Then
            ...
            Dim command As New WebEditAppointmentCommand(Control)
            command.Execute()
        End If
    End Sub
...
Public Class MenuHelper
    Public Shared Sub RemoveMenuItem(ByVal menu As ASPxSchedulerPopupMenu, ByVal menuItemName As String)
        Dim item As DevExpress.Web.MenuItem = menu.Items.FindByName(menuItemName)
